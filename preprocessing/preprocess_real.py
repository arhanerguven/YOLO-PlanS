...
image_path = "/media/arhan-erguven/Data/TestReal/images"
csv_files = [f for f in os.listdir(mother_path) if f.endswith('.csv')]

for file_name in csv_files:
    file_path = os.path.join(mother_path, file_name)
    file_nameim = file_name.replace(".csv","") + "/" + file_name.replace(".csv","") + "_0000000000.jpg"
    video_path = os.path.join(image_path, file_nameim)
